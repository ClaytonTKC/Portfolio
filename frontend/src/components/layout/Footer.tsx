                    ...
                    <div className="flex items-center gap-4">
                        {socialLinks.map((link) => (
                            <a
                                ...
                                className="w-10 h-10 rounded-lg bg-[var(--color-surface)] border border-[var(--glass-border)] flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-text)] hover:border-[var(--color-primary)] transition-all duration-300"
